...
data class PokeResult (
    ...
    @Expose @SerializedName("name") val name: String,
    @Expose @SerializedName("url") val url: String,
    @Expose @SerializedName("types") val types: List<TypeInfo>,
    @Expose @SerializedName("sprites") val sprites: OtherSprites?,
    @Expose @SerializedName("other") val other: OtherSprites,
    @Expose @SerializedName("official-artwork") val officialArtwork: OfficialArtwork,
    @Expose @SerializedName("height") val height: Int,
    @Expose @SerializedName("weight") val weight: Int,
    @Expose @SerializedName("base_experience") val baseExperience: Int,
    @Expose @SerializedName("isLoading") var isLoading: Boolean = false
)
